...
contract TSwapPool is ERC20 {
    ...
    function deposit(
        ...
        // IMPACT: HIGH a user who expects a deposit to fail, go through. Severe disruption of functionality
        // LIKELIHOOD: HIGH
        uint64 deadline
    )
        external
    ...
    // @audit-info where is the nat-spec??
    function swapExactInput(
        IERC20 inputToken, // e input token to swap / sell i.e. : DAI
        uint256 inputAmount, // e amount of input token to sell i.e.: DAI
        IERC20 outputToken, // e output token to buy / buy i.e.: WETH
        // e 7 DAI -> 1 WETH
        ...
        returns (uint256 inputAmount)
    {
        ...
        // 10 output DAI -> 10,000,000,000 input DAI
    ...
    function sellPoolTokens(
        ...
        // pool token -> input
        // @audit this is wrong!!
        // swapExactInput(minWethToRecieve)
        return
            swapExactOutput(
                i_poolToken,
                i_wethToken,
